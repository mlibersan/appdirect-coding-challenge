...
public class UserXMLParser {
	...
	private static final Logger logger = Logger.getLogger(UserXMLParser.class);
	...
	public Person parse(String xml) throws ParserConfigurationException, SAXException, IOException {
		...
		Map<String, String> userMap = parserUser(document);
		Map<String, String> compagnyMap = parserCompagny(document);
		Map<String, String> orderMap = parserOrder(document);

		Person person = new Person();
		person.setOpenId(userMap.get("openId"));
		person.setFirstName(userMap.get("firstName"));
		person.setLastName(userMap.get("lastName"));
	...
	protected Map<String, String> parserUser(Document document) {
		Map<String, String> map = new HashMap<String, String>();
